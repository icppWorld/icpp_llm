...
int main() {
  ...
  */
  ...
  // With temperature=0.0, the story will be the same every time
  // '(record {"prompt" = "" : text; "steps" = 100 : nat64; "temperature" = 0.0 : float32;})'
  ...
  mockIC.run_test(
      "inference", inference,
      "4449444c016c03b4e8c2e40373a7f7b9a00878a4a3e1aa0b71010000000000640000000000000000",
  ...
  // With temperature=1.0, the story will be the same every time
  // '(record {"prompt" = "I " : text; "steps" = 100 : nat64; "temperature" = 1.0 : float32;})'
  // -> '(variant { ok = "...generated story..." : text })'
  mockIC.run_test(
      "inference", inference,
      "4449444c016c03b4e8c2e40373a7f7b9a00878a4a3e1aa0b7101000000803f6400000000000000024920",
      "4449444c016b019cc20171010000152e2e2e67656e6572617465642073746f72792e2e2e",
      silent_on_trap, my_principal);
