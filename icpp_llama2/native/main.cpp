...
int main() {
  ...
  */
  ...
  // With temperature=0.0: greedy argmax sampling -> the story will be the same every time
  // '(record {prompt = "A C++ developer," : text; steps = 100 : nat64; temperature = 0.0 : float32; topp = 1.0 : float32;})'
  // -> '(variant { ok = "..." : text })'
  mockIC.run_test(
      "inference 1a", inference,
      "4449444c016c04b4e8c2e40373bbb885e80473a7f7b9a00878a4a3e1aa0b710100000000000000803f6400000000000000104120432b2b20646576656c6f7065722c",
      "",
      silent_on_trap, my_principal);

  // With temperature=0.0 & topp=0.9, still greedy argmax sampling -> the story will be the same every time
  // '(record {prompt = "A C++ developer," : text; steps = 100 : nat64; temperature = 0.0 : float32; topp = 0.9 : float32;})'
  // -> '(variant { ok = "..." : text })'
  mockIC.run_test(
      "inference 2a", inference,
      "4449444c016c04b4e8c2e40373bbb885e80473a7f7b9a00878a4a3e1aa0b710100000000006666663f6400000000000000104120432b2b20646576656c6f7065722c",
      "",
      silent_on_trap, my_principal);

  // With temperature>0.0 & topp=1.0: regular sampling
  // '(record {prompt = "A C++ developer," : text; steps = 100 : nat64; temperature = 0.9 : float32; topp = 1.0 : float32;})'
  // -> --can not check on story--
  mockIC.run_test(
      "inference 3a", inference,
      "4449444c016c04b4e8c2e40373bbb885e80473a7f7b9a00878a4a3e1aa0b7101006666663f0000803f6400000000000000104120432b2b20646576656c6f7065722c",
      "", silent_on_trap, my_principal);

  // With temperature>0.0 & topp<1.0: top-pp (nucleus) sampling
  // '(record {prompt = "A C++ developer," : text; steps = 100 : nat64; temperature = 0.9 : float32; topp = 0.9 : float32;})'
  // -> --can not check on story--
  mockIC.run_test(
      "inference 4a", inference,
      "4449444c016c04b4e8c2e40373bbb885e80473a7f7b9a00878a4a3e1aa0b7101006666663f6666663f6400000000000000104120432b2b20646576656c6f7065722c",
      "", silent_on_trap, my_principal);
